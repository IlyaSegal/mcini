...
class UEvent : public TObject {
 ...
 private:
  ...
  Double_t      fBx;            // Impact parameter in x direction (fm)
  Double_t      fBy;            // Impact parameter in y direction (fm)
 ...
 public:
  ...
  inline Double_t GetBx()      const {return fBx;}
  inline Double_t GetBy()      const {return fBy;}
  ...
  void SetParameters(Int_t eventNr, Double_t b, Double_t phi, Int_t nes,
		     Int_t stepNr, Double_t stepT, Double_t bx, Double_t by);
  inline void SetEventNr(Int_t eventNr)    {fEventNr = eventNr;}
  inline void SetB      (Double_t b)       {fB = b;}
  inline void SetBx     (Double_t b)       {fBx = b;}
  inline void SetBy     (Double_t b)       {fBy = b;}
